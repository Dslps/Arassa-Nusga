<div class="w-full max-w-[2000px] lg:pt-[15vh] pt-[140px] mx-auto">
    <div class="w-full flex">
        <div class="animate-left lg:w-[800px] lg:h-[660px] h-max bg-[var(--accent-color)]  flex flex-col lg:flex-row lg:items-center  px-10 xl:px-[100px] w-full">
        ...
        <div class="animate-bottom lg:flex hidden w-[1120px] px-[35px] xl:px-[100px] justify-center items-center">
            <img src="{{asset('img/service/bitrix24/box-corp.png')}}" alt="">
        </div>
