        ...
        <div class="max-w-[2000px] m-auto">
            ...
            <div class="flex flex-col lg:flex-row mt-[50px] lg:mt-[60px] 2xl:mt-[100px]">
                ...
                <div class="animate-block flex flex-wrap w-full justify-start">
                    <div
                        ...
                        <p class="base-text font-semibold">Антивирус Касперского</p>
                        <ul class="small-text list-none pl-[10px] space-y-[5px] mt-5">
                            <li class="list-marker">Продукт обеспечивает защиту в режиме реального времени от основных
                                информационных угроз — как известных, так и новых.</li>
                        </ul>
                    ...
                    @foreach ($kaspersky as $index => $kasper)
                        <div
                            ...
                            <p style="word-break: break-word; word-wrap: break-word; white-space: normal; max-width: 100%;"
                                ...
                                {{ $kasper->title_ru ?? 'Название не указано' }}
                            </p>

                            @php
                                $categories = $kasper->categories_ru ?? [];
                            @endphp
                                ...
                                <div>
                                    <div class="flex flex-col">
                                        ...
                                        <p class="number font-semibold">
                                            {{ number_format($kasper->price - ($kasper->price * $kasper->discount) / 100, 0, ',', ' ') }}
                                            тм
                                        </p>
                                    </div>
                                </div>
            ...
            <div class="flex flex-col lg:flex-row mt-[50px] lg:mt-[60px] 2xl:mt-[100px]">
                ...
                <div class="animate-block flex flex-wrap w-full justify-start">
                    <div
                        class="bg-[var(--accent-color)] w-full sm:w-[50%] h-[250px] 2xl:w-[25%] text-[var(--white-color)] p-[30px] flex flex-col hover:-translate-y-1 transition-transform duration-300">
                        <p class="base-text font-semibold">Антивирус ESET</p>
                        <ul class="small-text list-none pl-[10px] space-y-[5px] mt-5">
                            <li class="list-marker">Официальный антивирус гарантирует надежную защиту устройств, безопасное
                                соединение с интернетом и мгновенное удаление угроз.</li>
                        </ul>
            ...
            <div class="flex flex-col lg:flex-row mt-[50px] lg:mt-[60px] 2xl:mt-[100px]">
                ...
                <div class="animate-block flex flex-wrap w-full justify-start">
                    <div
                        class="bg-[var(--accent-color)] w-full sm:w-[50%] h-[250px] 2xl:w-[25%] text-[var(--white-color)] p-[30px] flex flex-col hover:-translate-y-1 transition-transform duration-300">
                        <p class="base-text font-semibold">Антивирус PRO32</p>
                        <ul class="small-text list-none pl-[10px] space-y-[5px] mt-5">
                            <li class="list-marker">PRO32 — IT-эксперт с 2005 года, ранее эксклюзивный представитель ESET в
                                СНГ. Предоставляет современные технологии для бизнеса и дома.</li>
                        </ul>
