...
<div class="mb-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
            ...
            <input type="text" id="title_ru" name="title_ru" value="{{ old('title_ru', $aboutUs->title_ru ?? '') }}"
        ...
        <div>
            ...
            <input type="text" id="title_en" name="title_en" value="{{ old('title_en', $aboutUs->title_en ?? '') }}"
                   class="border-2 border-dashed border-gray-300 p-2 w-full rounded focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                   maxlength="255">
            @error('title_en')
                <span class="text-red-500 text-sm">{{ $message }}</span>
        ...
        <div>
            ...
            <input type="text" id="title_tm" name="title_tm" value="{{ old('title_tm', $aboutUs->title_tm ?? '') }}"
                   class="border-2 border-dashed border-gray-300 p-2 w-full rounded focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                   maxlength="255">
            @error('title_tm')
                <span class="text-red-500 text-sm">{{ $message }}</span>
