...
@section('content')
    <div class="w-full h-[85vh]">
        <div class="max-w-[2000px] h-[70vh] m-auto">
            ...
            <div class="lg:max-w-[800px] w-full lg:h-[15vh] h-[140px] bg-[var(--accent-color)] text-[var(--white-color)] flex sm:flex-row flex-col items-center">
                <div class="carousel-dots flex gap-5 justify-center m-auto sm:ml-[100px] ">
                    <span class="dot w-3 h-3 bg-[var(--white-color)] rounded-full mx-2 cursor-pointer"></span>
                    <span class="dot w-3 h-3 bg-[var(--white-color)] rounded-full mx-2 cursor-pointer"></span>
                    <span class="dot w-3 h-3 bg-[var(--white-color)] rounded-full mx-2 cursor-pointer"></span>
                </div>
                <div class="m-auto flex gap-[45px]">
    ...
    <div class="w-full px-0 lg:px-[60px] 2xl:px-[100px] m-auto mt-[80px] xl:mt-[80px] 2xl:mt-[130px] ">
        <div class="max-w-[2000px] m-auto">
            ...
            <div class="flex flex-col lg:flex-row mt-[50px] lg:mt-[60px] 2xl:mt-[100px]">
                ...
                <!-- Блок 2 -->
                <div class="flex flex-wrap h-max justify-start border border-gray-300">
                    <a href="">
                        <div class="p-[30px] w-full sm:w-[50%] lg:w-[50%] 2xl:w-[33%]  flex flex-col bg-white group hover:shadow-lg transition-shadow duration-300 border-b border-r border-gray-200">
    ...
    <div class="w-full mx-auto max-w-[2000px] m-auto flex flex-col lg:flex-row bg-[var(--template-color)] mt-[115px]">
        ...
        <div class="px-5 py-16 lg:p-[80px] xl:p-[100px] text-[var(--white-color)]">
            <div class="max-w-[870px]">
                ...
                <ul class="ml-[10px] base-text space-y-[15px]">
                    <li class="list-marker">Консалтинговая компания «Arassa Nusga», основанная в 2017 году в составе Lotta
                    ...
                    <li class="list-marker">Мы всегда стремимся превзойти ожидания наших клиентов, предоставляя больше, чем
