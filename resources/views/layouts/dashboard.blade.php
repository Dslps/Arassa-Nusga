            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="" class="flex ms-2 md:me-24">
                        <img src="{{ asset('img/logo-img.png') }}" class="h-8 me-3" alt="FlowBite Logo" />
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Arassa
                            Nusga</span>
                    </a>
                </div>
                    ...
                    <div class="flex items-center ms-3">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                            ...
                            <ul class="py-1" role="none">
                                ...
                                <li>
                                    <form class="px-4 py-2" action="{{ route('logout') }}" method="POST">
                                        @csrf
                                        <button type="submit"
                                            class="block  text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{route('about-us-dash')}}"
                        ...
                        <span
                            class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">2</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('blog-dash')}}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 18 18">
                ...
                <li class="relative group">
                    ...
                    <button type="button"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap text-start">Service</span>
                        <svg class="w-4 h-4 ml-auto text-gray-400 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                ...
                <li>
                    <a href="{{route('contact-dash')}}"
                        ...
                        <span
                            class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">5<span>
                    </a>
                </li>
                <li>
                    <a href="{{route('users')}}"
